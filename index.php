...
<div class="page-wraper">
    ...
    <div class="page-content bg-white">
        <!-- Section Banner -->
		<div class="dlab-bnr-inr dlab-bnr-inr-md" style="background-image:url(images/main-slider/gujjuads-banner.jpg); background-size: cover;">
            <div class="container">
                <div class="dlab-bnr-inr-entry align-m dlab-home">
					<div class="bnr-content">
						<h2 style="color:white"><strong>SEARCH YOUR </strong> <strong class="color:black">BUSINESS</strong></h2>
					</div>
            ...
            <div class="section-full bg-white content-inner" style="background-image:url(images/background/bg5.jpg); background-position:bottom; background-size: cover;">
                <div class="container">
					<div class="section-head text-black text-center">
						...
						<h2 class="box-title">BUSINESS CATEGORY</h2>
						<div class="dlab-separator bg-primary"></div>
						
					</div>
                    <div class="row">
                    	<?php $q = "SELECT * FROM dep_tbl"; 
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="featured-bx m-b30">
								<div class="featured-media">
									<img src="./admin/category_img/<?php echo $rw['photo']; ?>"  alt=""/>
								</div>	
								<div class="featured-info">
<h5 class="title"><a href="listing-details.php?id=<?php echo $rw['id']?>"><?php echo $rw['depname']; ?></a></h5>
